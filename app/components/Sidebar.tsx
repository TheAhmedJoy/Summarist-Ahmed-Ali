        ...
        >
            ...
            <div className={`${styles.group} ${styles.group1}`}>
                <div className={styles.linkWrapper}>
                    <div className={`${styles.link__tab} ${pathname === "/for-you" ? styles.active : ""}`} />
                ...
                <div className={styles.linkWrapper}>
                    <div className={`${styles.link__tab} ${pathname === "/library" ? styles.active : ""}`} />
                    <div className={styles.linkIconWrapper}>
                        <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13.5a.5.5 0 0 1-.777.416L8 13.101l-5.223 2.815A.5.5 0 0 1 2 15.5V2zm2-1a1 1 0 0 0-1 1v12.566l4.723-2.482a.5.5 0 0 1 .554 0L13 14.566V2a1 1 0 0 0-1-1H4z"></path>
                        </svg>
                    </div>
                    <Link className={`${styles.item} ${styles.disabled}`} href="#" onClick={(e) => e.preventDefault()}>
                        My Library
                    </Link>
                </div>
                <div className={styles.linkWrapper}>
            ...
            <div className={styles.group}>
                <div className={styles.linkWrapper}>
                    <div className={`${styles.link__tab} ${pathname === "/settings" ? styles.active : ""}`} />
                    <div className={styles.linkIconWrapper}>
            ...
            <button className={styles.closeBtn} type="button" onClick={onCloseAction} >
                ✕
            </button>
        </aside>
    )
